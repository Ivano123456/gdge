...
local PlayerActions = {
  {
    ...
    onClick = function(player, args)
      ...
      local attempt_give_item = lib.callback.await('lc_admin:player_actions:qbx:attemptGiveItem', 100, tonumber(player.source), args[1], args[2])
  ...
  },
  {
    ...
    onClick = function(player)
      TriggerServerEvent('lc_admin:player_actions:qbx:heal', player.source)
    end
  },
  {
    ...
    onClick = function(player)
      CloseAdminMenu()
      TriggerServerEvent('lc_admin:player_actions:qbx:viewInventory', player.source)
    end
  },
  {
    ...
    onClick = function(player)
      TriggerServerEvent('lc_admin:player_actions:qbx:clearInventory', player.source)
    end
  },
  {
    ...
    permission = 'clear_inventory',
    onClick = function(player)
      TriggerServerEvent('lc_admin:player_actions:qbx:confiscateInventory', player.source)
    end
  },
  {
    ...
    permission = 'clear_inventory',
    onClick = function(player)
      TriggerServerEvent('lc_admin:player_actions:qbx:returnInventory', player.source)
    end
  },
  {
    ...
    onClick = function(player, args)
      ...
      TriggerServerEvent('lc_admin:player_actions:qbx:setBucket', player.source, args[1])
    end
  }
}
