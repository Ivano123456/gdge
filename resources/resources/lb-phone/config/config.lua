...
Config.AnimationStyle = "default" -- "default" or "two handed". Can be modified in config/animations.lua and client/custom/functions/animations.lua
...
Config.Companies.Services = {
    {
        ...
        location = {
            name = "Policijska Uprava",
            coords = { x = -576.32, y = -417.62 }
        },
        quickReplies = {
            ["Posaljite lokaciju"] = "Molim vas posaljite vasu trenutnu lokaciju.",
            ["Sluzbenik je na putu"] = "Sluzbenik je uputio prema vasoj lokaciji.",
        },
    },
    {
        job = "sud",
        ...
        location = {
            name = "Sud",
            coords = { x = -1579.88, y = 186.90 }
        },
        quickReplies = {
            ["Posaljite lokaciju"] = "Molim vas posaljite vasu trenutnu lokaciju.",
            ["Kontaktiran ste"] = "Sud vas kontaktira. Molimo odgovorite sto pre.",
        },
    },
    {
        job = "hitna",
        ...
        bossRanks = { "nacelnik" },
        location = {
            name = "Okruzna Bolnica",
            coords = { x = -813.6456, y = -1231.8682 }
        },
        quickReplies = {
            ["Posaljite lokaciju"] = "Molim vas posaljite vasu trenutnu lokaciju.",
            ["Tim je na putu"] = "Medicinski tim je uputio prema vasoj lokaciji.",
        },
    },
    {
        job = "autoumro",
        ...
        location = {
            name = "Auto Umro",
            coords = { x = 1075.15, y = -905.54 }
        },
        quickReplies = {
            ["Posaljite lokaciju"] = "Molim vas posaljite lokaciju vozila.",
            ["Mehanicar je na putu"] = "Mehanicar je uputio prema vasoj lokaciji.",
        },
    },
}
...
Config.Locations = {
    {
        position = vector2(-576.32, -417.62),
        name = "Policijska Uprava",
        description = "Policijska Uprava",
        icon = "https://cdn-icons-png.flaticon.com/512/7211/7211100.png",
    },
    {
        position = vector2(-813.6456, -1231.8682),
        name = "Okruzna Bolnica",
        description = "Hitna pomoc",
        icon = "https://cdn-icons-png.flaticon.com/128/1032/1032989.png",
    },
    {
        position = vector2(1075.15, -905.54),
        name = "Auto Umro",
        description = "Mehanicarska radnja",
        icon = "https://cdn-icons-png.flaticon.com/128/10281/10281554.png",
    },
}
