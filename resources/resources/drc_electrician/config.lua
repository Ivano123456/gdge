...
Config.FuelType = 'legacy_fuel' -- legacy_fuel / ox_fuel / ps_fuel
...
Config.JobPrivateLocations = {
    LowTier = {
        ...
        ExperienceReward = 1,
        Reward = {Min = 200, Max = 300}, -- Reward range for LowTear
        Locations = {
    ...
    MediumTier = {
        ...
        ExperienceReward = 3,
        Reward = {Min = 200, Max = 380}, -- Reward range for MediumTear
        Locations = {
