...
RegisterNetEvent("illenium-appearance:client:openShop", function(shopType, isPedMenu)
    local config = GetDefaultConfig()
    ...
    OpenShop(config, isPedMenu, shopType)
end)

local function OpenClothingShop(isPedMenu)
    TriggerServerEvent("illenium-appearance:server:openShop", "clothing", isPedMenu)
end
...
RegisterNetEvent("illenium-appearance:client:openBarberShop", function()
    TriggerServerEvent("illenium-appearance:server:openShop", "barber", false)
end)

RegisterNetEvent("illenium-appearance:client:openTattooShop", function()
    TriggerServerEvent("illenium-appearance:server:openShop", "tattoo", false)
end)

RegisterNetEvent("illenium-appearance:client:openSurgeonShop", function()
    TriggerServerEvent("illenium-appearance:server:openShop", "surgeon", false)
end)

function OpenBarberShop()
    TriggerServerEvent("illenium-appearance:server:openBarberShop")
end

function OpenTattooShop()
    TriggerServerEvent("illenium-appearance:server:openTattooShop")
end

function OpenSurgeonShop()
    TriggerServerEvent("illenium-appearance:server:openSurgeonShop")
end
