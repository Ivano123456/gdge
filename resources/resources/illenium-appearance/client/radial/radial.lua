...
function Radial.AddOption(currentZone)
    ...
    local zoneEvents = {
        ...
        clothing = {"illenium-appearance:server:openClothingShopMenu", _L("menu.clothingShopTitle")},
        barber = {"illenium-appearance:server:openBarberShop", _L("menu.barberShopTitle")},
        tattoo = {"illenium-appearance:server:openTattooShop", _L("menu.tattooShopTitle")},
        surgeon = {"illenium-appearance:server:openSurgeonShop", _L("menu.surgeonShopTitle")},
    }
