...
Config.Notification = 'ox_lib' --[ 'auto_detect' / 'other' ]
...
Config.Permissions = { --Define which players can access the cd_easytime features.
    Framework = { --Ignore this section if you're not using a framework.
        ['esx'] = {'vlasnik', 'suvlasnik', 'asistent', 'menadzer', 'vodja_admina', 'vodja_lidera', 'vodja_eventa', 'headadmin', 'superadmin' },
        ['qbcore'] = {'god', 'admin', },
        ['qbox'] = {'god', 'admin', },
    },
...
Config.Weather = {
    ...
    GameWeather = { --If you chose 'game', you have the following configurable options:
        dynamic_weather_time = 15, --How often (in minutes) should the weather change?
        rain_chance = 10, --Chance of rain (0-100%) if the rain WeatherGroup is randomly selected.
        ...
        snow_chance = 0, --Chance of snow (0-100%) if the rain WeatherGroup is randomly selected.
