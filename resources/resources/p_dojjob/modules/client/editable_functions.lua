...
Editable = {
    spawnVehicle = function(model, data, points)
        ...
        elseif GetResourceState('MrNewbVehicleKeys') == 'started' then
            exports.MrNewbVehicleKeys:GiveKeysByPlate(vehPlate)
        end
        return vehicle
    end,
    hideVehicle = function(entity)
        if entity and DoesEntityExist(entity) then
            ...
            elseif GetResourceState('MrNewbVehicleKeys') == 'started' then
                exports.MrNewbVehicleKeys:RemoveKeysByPlate(vehPlate)
            end
    ...
    openInventory = function(invType, data)
        ...
        elseif GetResourceState('origen_inventory') == 'started' then
            exports.origen_inventory:openInventory(invType, type(data) == 'table' and (data.id..'_'..data.owner) or data.id)
