return {
	Weapons = {
		...
		['WEAPON_ASSAULTSMG_OMEX_FREE01'] = {
			label = 'Assault SMG Cashback',
			weight = 8000,
			durability = 0.05,
			ammoname = 'ammo-rifle'
		},

		['WEAPON_SPECIALCARBINE_MK2_OMEXFREE01'] = {
			label = 'Special Carbine Cashback',
			weight = 12700,
			durability = 0.03,
			ammoname = 'ammo-rifle'
		},

		['WEAPON_COMBATMG_MK2_GRAVEYARD'] = {
			label = 'Combat MG Graveyard',
			weight = 6500,
			durability = 0.03,
			ammoname = 'ammo-rifle2'
		},
	...
	Components = {
		...
		['at_assaultsmg_cashback_anim'] = {
			label = 'Assault SMG Cashback Anim',
			type = 'skin',
			weight = 0,
			client = {
				component = {
					`WEAPON_SKIN_OMEX_BASE`,
					`COMPONENT_ASSAULTSMG_FREE01_ANIM`,
				},
				usetime = 2500
			}
		},

		['at_specarbine_cashback_anim'] = {
			label = 'Spe Carbine Cashback Anim',
			type = 'skin',
			weight = 0,
			client = {
				component = {
					`COMPONENT_SPECIALCARBINE_MK2_OMEXFREE01_ANIM`,
				},
				usetime = 2500
			}
		},

		['at_combatmg_graveyard_anim'] = {
			label = 'Graveyard Anim',
			type = 'skin',
			weight = 0,
			client = {
				component = {
					`COMPONENT_COMBATMGMK2_GRAVEYARD_ANIM`,
				},
				usetime = 2500
			}
		},
