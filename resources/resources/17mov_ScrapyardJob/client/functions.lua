...
RegisterNetEvent("17mov_ScrapyardJob:Notify", function(msg)
    Notify(msg)
end)
...
function ChangeClothes(type)
    if Config.Framework ~= "QBCore" and Config.Framework ~= "ESX" then
        Core.Print("CANNOT CHANGE CLOTHES, PLEASE CONFIGURE UR CLOTHES SYSTEM IN /Client/Functions.lua file.")
    end
