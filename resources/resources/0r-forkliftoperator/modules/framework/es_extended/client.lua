...
Framework.ItemList = function()
    ...
    local items = lib.callback.await(Event('callback:getFrameworkItems'), false)
...
Framework.GetFrameworkJobs = function()
    local jobs = lib.callback.await(Event('callback:getFrameworkJobs'), false)
    return jobs
end
...
RegisterNetEvent('esx:playerLoaded', function(xPlayer)
    Wait(1500)
    TriggerEvent(Event('client:onPlayerLoaded'))
end)
