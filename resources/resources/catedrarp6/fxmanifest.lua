...
files {
  'mp_m_freemode_01_mp_m_catedra6_shop.meta',
  'mp_f_freemode_01_mp_f_catedra6_shop.meta',
  'pedalternatevariations.meta',
  'first_person_alternates.meta'
}

data_file 'SHOP_PED_APPAREL_META_FILE' 'mp_m_freemode_01_mp_m_catedra6_shop.meta'
data_file 'SHOP_PED_APPAREL_META_FILE' 'mp_f_freemode_01_mp_f_catedra6_shop.meta'
