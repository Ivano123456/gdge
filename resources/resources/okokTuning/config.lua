...
Config.OnlyAffectUpgrades = false          -- If true, the percentage will only affect the upgrades, not the base price
...
Config.Zones = {

      {
            name         = "Auto Umro",
            jobs         = { "autoumro" },
            coords       = vector3(1075.1473, -905.5363, 50.8373),
            size         = vector3(5, 5, 5),
            rotation     = 96.8910,
            type         = "job",
            debug        = false,
...

      {
            name         = "Auto Umro",
            jobs         = { "autoumro" },
            coords       = vector3(1076.5071, -911.6891, 50.8374),
            size         = vector3(5, 5, 5),
            rotation     = 354.7145,
            type         = "job",
            debug        = false,
      ...
      },
      {
            name         = "Auto Umro",
            jobs         = { "autoumro" },
            coords       = vector3(1078.5441, -918.1284, 50.8374),
            size         = vector3(5, 5, 5),
            rotation     = 195.9463,
            type         = "job",
            debug        = false,
      ...
      },
      {
            name         = "Auto Umro",
            jobs         = { "autoumro" },
            coords       = vector3(1072.5394, -899.7342, 50.8371),
            size         = vector3(5, 5, 5),
            rotation     = 282.3090,
            type         = "job",
            debug        = false,
      ...
      },
      {
            name         = "Auto Fušeraj",
            jobs         = { "autofuseraj" },
            coords       = vector3(-332.4123, -1368.1034, 31.5059),
            size         = vector3(5, 5, 5),
            rotation     = 0.7094,
            type         = "job",
            debug        = false,
      ...
      },
      {
            name         = "Auto Fušeraj",
            jobs         = { "autofuseraj" },
            coords       = vector3(-340.1003, -1367.8235, 31.5098),
            size         = vector3(5, 5, 5),
            rotation     = 252.1227,
            type         = "job",
            debug        = false,
      ...
      },
      {
            name         = "Auto Fušeraj",
            jobs         = { "autofuseraj" },
            coords       = vector3(-347.6333, -1367.6821, 31.5101),
            size         = vector3(5, 5, 5),
            rotation     = 146.7819,
            type         = "job",
            debug        = false,
      ...
      },
      {
            ...
            jobs        = { "police" },
            coords      = vector3(-599.7702, -424.2583, 30.7483),
            size        = vector3(8, 8, 5),
            rotation    = 85.4050,
            type        = "job",
            debug       = false,
      ...
      upgrades = {
            {
                  ...
                  basePrice = 3000,
                  incrementPercent = 1 -- Controls the price scaling curve between mod levels (0.5 = gentler increases, 1.0 = default, 2.0 = steeper increases)
            },
            {
