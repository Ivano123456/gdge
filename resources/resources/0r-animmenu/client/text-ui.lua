            ...
            if dist <= v.data.displayDist then
                ...
                if dist <= v.data.interactDist then
                    ...
                    if onScreen then
                        ...
                        ClearDrawOrigin()
                        -- Bg
                        local bgCenterX = 0.018 + (width / 2)
                        SetScriptGfxAlignParams(bgCenterX, 0 * 0.03 - 0.0125, 0.0, 0.0)
                        SetTextScale(0, 0.25)
                        SetTextFont(8)
                        SetTextColour(255, 255, 255, 255)
                        BeginTextCommandDisplayText("STRING")
                        ...
                        SetDrawOrigin(v.data.coords.x, v.data.coords.y, v.data.coords.z)
                        SetTextJustification(0)
                        EndTextCommandDisplayText(0.0, 0.001)
                        ResetScriptGfxAlign()
                        SetScriptGfxAlignParams(bgCenterX, 0 * 0.03 - 0.015, 0.0, 0.0)
