...
Config.Command = {
    enable = false, -- false / true, enable the /jailmdt command
...
Config.MaxJailTime = 240 -- maximum jail time in minutes (0 = no limit)
Config.UseNameSelector = true -- false / true, show nearby player names in MDT home instead of player id + closest player switch
...
Config.MDTCoords = { -- coords where you can open the prison MDT (you won't need the item)
    vec3(1839.6123, 2584.5007, 46.0144)
}
